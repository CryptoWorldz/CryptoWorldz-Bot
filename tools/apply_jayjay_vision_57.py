...
SPECIAL = {
    "donateworldz.com": '''<section class="section" data-jayjay-57="donate-3"><p class="eyebrow">Give clearly</p><h2>Support must stay separated and understandable.</h2><div class="grid"><div class="info-card"><strong>Purpose first</strong><span>Each active pathway states who it supports.</span></div><div class="info-card"><strong>Destination clear</strong><span>Payment happens only through the displayed provider page.</span></div><div class="info-card"><strong>Truth over pressure</strong><span>No invented counters, urgency claims or hidden streams.</span></div></div></section>''',
