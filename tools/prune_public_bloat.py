...
assert "support jayjayteamdev" in donate and "jayjay-support" in donate
...
print(f"PRUNE_PUBLIC_BLOAT=PASS pages={len(urls)} roots=18 mission_pages=25 retired_routes={len(set(retired))} jayjay_mission_support=1")
