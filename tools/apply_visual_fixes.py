...
<main class="shell">
<section class="hero mission-hero" data-verified-identity="cryptoworldz-text-first"><div class="hero-copy"><p class="eyebrow">One World • One Mission</p><h1>CryptoWorldz.</h1><p>Building the Future of Crypto Together — with Zed, Command Centre Ultimate™, Worldz discovery, education, community and real-world impact.</p><div class="actions"><a class="btn" href="https://cryptobotz.cryptoworldz.xyz">Open Command Centre Ultimate™</a><a class="btn secondary" href="https://t.me/CryptoWorldzBot">Open Zed Bot</a></div></section>
