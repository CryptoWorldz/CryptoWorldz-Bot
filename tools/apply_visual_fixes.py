...
<main class="shell">
<section class="hero" data-verified-identity="cryptoworldz-command-centre"><div class="hero-grid"><div class="hero-copy"><p class="eyebrow">One World • One Mission</p><h1>CryptoWorldz.</h1><p>Building the Future of Crypto Together — with Zed, Command Centre Ultimate™, Worldz discovery, education, community and real-world impact.</p><div class="actions"><a class="btn" href="https://cryptobotz.cryptoworldz.xyz">Open Command Centre Ultimate™</a><a class="btn secondary" href="https://t.me/CryptoWorldzBot">Open Zed Bot</a></div></div><img class="hero-art" src="/command-centre-five.png" alt="CryptoWorldz Command Centre Ultimate artwork"></div></section>
