...
MAIN_JPG = '/assets/support/davis-family/davis-family-hero.jpg'
MAIN_WEBP = '/assets/support/davis-family/davis-family-hero.webp'
...
BUILD = '2026-09-19-davis-family-approved-hero-v5'
...
print('DAVIS_PAGE=PASS approved_hero_jpg=1 approved_hero_webp=1 profile_home=1 copy=1 stripe=1 facebook=1 mobile=1')
