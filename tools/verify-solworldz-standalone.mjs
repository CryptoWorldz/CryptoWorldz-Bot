...
assert.ok(html.includes('https://gofund.me/933219353'),'Community Survival Fund link missing');
...
console.log('SolWorldz production gate passed: approved PNG hero/atlas, current pipeline, Survival Fund route and Robin Hood Chain classification verified.');
