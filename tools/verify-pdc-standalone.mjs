...
const reaganFundraiser = 'https://gofund.me/c2e4fa936';
const communityFundraiser = 'https://gofund.me/933219353';
const jayProfile = 'https://www.gofundme.com/u/jayjayteamdev';
assert.ok(home.includes(reaganFundraiser), 'Current Reagan donation link missing');
assert.ok(donate.includes(reaganFundraiser), 'Donate page Reagan fundraiser missing');
assert.ok(donate.includes(communityFundraiser), 'Donate page Community Survival Fund missing');
assert.ok(donate.includes(jayProfile), 'Donate page JayJayTeamDev GoFundMe profile missing');
assert.ok(donate.includes('https://oneworldz.com/gofundme/'), 'Donate page OneWorldz GoFundMe hub route missing');
...
const tokens = [
  ['Original PDC','F82HFwxDLKFAbQWq7BmniWWxMgUerQsVu8jS357epump'],['First PDC1','PDC1K9aG6vAg5jFYkLin2tdTgwqZypsdvVHhHN2WnWw'],['PDC1-2','PDC1NgvtvLZwnopTfQdzXT5iAqBeGyLdFXEcqnvsR52'],['PDCMAGA','7mwWRQeNpwWrnNhRpC48k7xQCdjCXDWfLLuYsphupump'],['PDCShares','PDCLsBaTM3MxCzTWNoRvQejZ4kkhAWZiSc3ipCsoFuE'],['PurpleDC','9Jd67VEgqWA2K5mck7yiYGxfLrQnmrTnXXzDYE3b7MLf'],['OG Purple','DyZP9zn6vRu8J8XCQLNCREgCc12YN4JndnrmE5Upump'],['PCC1 legacy','DcekG6rLbQ3K5LtZfSMLgecfqnFAZgJUSpoY7tBgmuGv'],['INVEST','VeSt6vaWE5JsT36sVCzL21daiY7nNNs73TJcJMHgnjC'],['Limited Edition','Lmtdfb2b392STncVxf2rD6csY4w1rxuHEMizv7vXVtY']
];
...
console.log('PurpleDiamondCrew production gate passed: approved PNG artwork, Reagan + Community Survival Fund routes, seven site pages, 10 real PDC legacy records and LMTD Streamflow locks verified.');
