...
# JayJayTeamDev image contract:
# - natural proportions only
# - no stretching, forced crop, square-in-wide or portrait-in-wide distortion
# - simple rectangular/square shells only
# - mobile stacks cleanly instead of squeezing artwork
# - approved hero artwork stays fully visible
...
# Replace only known bad cross-site card allocations with approved landscape artwork.
# These replacements affect card/portal use only; local site heroes remain untouched.
SOURCE_FIXES={
    'https://cryptoworldz.xyz/hero.png':'https://cryptoworldz.xyz/command-centre-five.png',
    'https://donateworldz.com/reagan.png':'https://donateworldz.com/hero.png',
}
