...
req(v["authorityRules"]["operations"]["requiredGovernance"]=="5-of-10","operations governance must be 5-of-10")
req(v["authorityRules"]["operations"]["upgradeRequired"] is True,"operations upgrade must remain required until proven")
req(v["authorityRules"]["reserve"]["requiredGovernance"]=="6-of-9","reserve governance must be 6-of-9")
req(v["authorityRules"]["reserve"]["deploymentRequired"] is True,"reserve deployment must remain required until proven")
