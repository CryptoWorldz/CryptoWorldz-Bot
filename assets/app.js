...
mobileLayoutFix.textContent='html,body{width:100%;max-width:100%;overflow-x:hidden;overscroll-behavior-x:none}body{position:relative}main,header,footer,section,.section,.hero,.mission,.explore,.impact,.launch,.cta,.feature-grid,.portal-grid,.launch-grid,.impact-panel{width:100%;max-width:100%;min-width:0}.hero>*,.feature-grid>*,.portal-grid>*,.launch-grid>*,.impact-panel>*{min-width:0;max-width:100%}.hero-art{width:100%;max-width:100%;overflow:hidden}h1,h2,h3,p,a,strong,span{overflow-wrap:anywhere}@media(max-width:760px){.header{width:100%;max-width:100%}.hero{overflow:hidden}.hero-art{min-height:320px}.orbit{width:min(92vw,360px)}.orbit-b{width:min(98vw,390px)}.planet{width:min(66vw,240px)}.section{padding-left:16px;padding-right:16px}.row{flex-wrap:wrap}.row strong{max-width:100%}.mobile-nav{width:100%;max-width:100%}}';
