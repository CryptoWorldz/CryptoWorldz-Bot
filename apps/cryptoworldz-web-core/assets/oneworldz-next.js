...
<section id="worldz" class="wx-panel owz-worlds-panel"><span class="wx-kicker">ONE ECOSYSTEM • MANY WORLDZ</span><h2>Explore the Worldz</h2><p>Open any connected destination directly from the OneWorldz gateway.</p><div class="wx-worlds">${worldGrid()}</div><div class="wx-actions owz-command-row">${btn(COMMAND,'Open CryptoWorldz Command Centre','wx-btn gold')}${btn(BOT,'Open @CryptoWorldzBot')}</div></section>
