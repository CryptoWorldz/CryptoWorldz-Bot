...
const { registerFullBuildTelegramHandlers } = require("./fullbuild/telegram");
...
async function start() {
  ...
  startupStage = "register_worldz_fullbuild";
  registerFullBuildTelegramHandlers({ bot, repository, config, supabase });
