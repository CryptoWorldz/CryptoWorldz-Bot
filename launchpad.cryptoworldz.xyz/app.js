...
})();+symbol+'</em><small>'+stage+' • '+env+'</small></div><div class="market-stat"><span>Engine</span><b>'+engine+'</b></div><div class="market-stat"><span>Token fee</span><b>'+feeText+'</b></div><div class="market-stat"><span>Mint</span><b>'+mint+'</b></div><span class="arrow">TRUST →</span></a>';
    }).join('');
  }catch(e){
    target.innerHTML='<article class="market-card"><div><strong>Public registry temporarily unavailable</strong><small>Launch building remains available. Registry failures are shown as unknown, never silently green.</small></div></article>';
  }
