...
if ($_SERVER['REQUEST_METHOD'] === 'OPTIONS') {
  header('Access-Control-Allow-Origin: https://launchpad.cryptoworldz.xyz');
...
foreach ($upstreams as $upstream) {
  ...
  curl_setopt_array($ch, [
    ...
    CURLOPT_USERAGENT => 'WorldzLaunchPad-REVIVE-Distribution/2.0'
  ]);
  $out = curl_exec($ch);
...
echo json_encode([
  ...
  'error'=>[
    'code'=>-32000,
    'message'=>'Upstream Solana RPC unavailable',
    'detail'=>$lastErr,
    'http'=>$lastCode
  ],
  'id'=>$body['id'] ?? null
