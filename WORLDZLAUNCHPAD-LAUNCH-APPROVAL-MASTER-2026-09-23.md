...
**Status:** Working approval master — no on-chain transaction or public sale is authorized by this file.  
...
- No token reward is earned for undisclosed promotion, price promises, or misleading claims.
...
### Proposed distribution update

| Allocation | Share | WLDZ |
|---|---:|---:|
| Legacy Purple Diamond Handz pool | 5.0% | 5,000,000 |
| Dev City | 5.4% | 5,400,000 |
| Community / Command Centre rewards | 1.6% | 1,600,000 |
...
- A launch qualifies only when it uses the official WorldzLaunchPad / WorldMint Meteora configuration, creator and project are verified, and published anti-spam/activity conditions are met.
...
| Dev City: 54 wallets x 0.2% | 10.8% |
| Charity impact | 8.0% |
| Worldz Treasury | 5.0% |
| General reserve | 5.0% |
...
| Fair early-access allocation | 6.2% |
| **Total** | **100.0%** |

## Command Centre Kitty

The 5% Kitty is for verifiable community contribution, including onboarding, translations, testing, education, moderation and scam reporting. It is not a reward for hidden promotion, price predictions or token-buying pressure.
...
- A separate discount or private price would require a separately disclosed whitelist-sale or claim mechanism.
