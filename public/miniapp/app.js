...
function render() {
  ...
  byId("fullbuild-home-card").innerHTML = `<article class="panel"><p class="eyebrow">🌐 WORLDZFULLBUILD™</p><h3>The master architecture for the complete Worldz technology build.</h3><p>WorldzFullScope™ is now a required subsystem inside FullBuild—not a side module.</p><div class="form-row"><button class="button" type="button" data-open="fullbuild">Open FullBuild</button><button class="button secondary" type="button" data-open="fullscope">Open FullScope</button></div></article>`;
