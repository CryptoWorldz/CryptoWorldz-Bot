...
const report={
 status:poolSim.value.err===null?'BUILT_AND_SIMULATED_POOL_AND_PROPOSAL_SETUP':('BUILT_NEEDS_VAULT_SOL_'+(minTopup??'UNKNOWN')),broadcast:false,valueMoved:false,network:'mainnet-beta',
