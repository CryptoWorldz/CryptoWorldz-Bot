...
const allowedStatuses=new Set(['PREPARED_NOT_SIGNED','OWNER_AUTHORIZED__AWAITING_LIVE_SQUADS_THRESHOLD']);
...
if(candidate.launchAuthorized){
  A(candidate.status==='OWNER_AUTHORIZED__AWAITING_LIVE_SQUADS_THRESHOLD','owner-authorized status mismatch');
...
const report={
  status:candidate.launchAuthorized?'PASS_OWNER_AUTHORIZED_AWAITING_SQUADS_THRESHOLD':'PASS_PREPARATION_ONLY',
